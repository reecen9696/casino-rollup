    ...
    <div className="test-results border border-gray-200 rounded-lg p-6 bg-white shadow-sm">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Test ID: {testResult.id}</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          >
            {testResult.status.charAt(0).toUpperCase() +
              testResult.status.slice(1)}
          </span>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {testResult.metrics.errorRate.toFixed(2)}%
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatLatency(testResult.metrics.minLatency)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">P50:</span>
                  <span className="font-medium">
                    {formatLatency(testResult.metrics.p50Latency)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">P95:</span>
                  <span className="font-medium">
                    {formatLatency(testResult.metrics.p95Latency)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">P99:</span>
                  <span className="font-medium">
                    {formatLatency(testResult.metrics.p99Latency)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Max:</span>
                  <span className="font-medium">
                    {formatLatency(testResult.metrics.maxLatency)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {testResult.metrics.headsResults}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">🪙 Tails Results:</span>
                  <span className="font-medium">
                    {testResult.metrics.tailsResults}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">✅ Correct Guesses:</span>
                  <span className="font-medium text-green-600">
                    {testResult.metrics.correctGuesses}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">💰 Total Payout:</span>
                  <span className="font-medium text-purple-600">
                    {(testResult.metrics.totalPayout / 1000000).toFixed(3)} SOL
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">🎯 Win Rate:</span>
                  <span className="font-medium">
                    {testResult.metrics.totalRequests > 0
                      ? (
                          (testResult.metrics.correctGuesses /
                            testResult.metrics.successfulRequests) *
                          100
